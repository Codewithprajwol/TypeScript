...
let numbers = [1, 2, 3, 4, 5, 6]; //? it will not throw array
...
let firstNameField = document.querySelector('#input'); // it says firstNameField as element or null
...
function nextDayForWeekDay(weakday) {
    switch (weakday) {
